...
// vincability.com/vindicator, and vendor the game's shared CSS.
//
...
static string RewriteInternalLinks(string bodyHtml, string kind) =>
    Regex.Replace(bodyHtml, "href=\"([^\"]+)\"", match =>
    {
...
string Shell(string title, string active, int depth, string content, string description)
{
    ...
    string nav = $"""
      <header class="site-nav">
        ...
        <a class="site-nav__ext" href="{root}../index.html">Vincability</a>
      </header>
    """;
...
static string FindSite([CallerFilePath] string self = "")
{
    ...
    return dir is not null
        ...
        : throw new InvalidOperationException("run from inside the vincability.com repo");
}
